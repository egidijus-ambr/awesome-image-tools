...
- [Narqo](https://narqo.com) 🔒 — Converts iPhone HEIC and HEIF photos to JPG, PNG or WebP in the browser, and between WebP, AVIF, PNG, JPG, GIF, SVG, BMP and ICO; no upload or sign-up, though large batches are limited by your device's memory.
